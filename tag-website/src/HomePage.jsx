        ...
        <div className="pricing-card pricing-card-unified">
          ...
          <div className="pricing-options">
            <div className="pricing-option">
              ...
              <p className="pricing-from">From <span className="pricing-option-price">£{prices.week1}</span></p>
            </div>
            <div className="pricing-option">
              <span className="pricing-label">2 WEEK TRIP</span>
              <p className="pricing-from">From <span className="pricing-option-price">£{prices.week2}</span></p>
            </div>
          </div>

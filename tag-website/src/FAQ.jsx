  ...
  const faqData = [
    {
      ...
      questions: [
        { q: "How do I make a booking?", a: "You can make a booking through our website at www.tagparking.co.uk, by phone on 01202 798710, or by email at info@tagparking.co.uk. You will need to provide your name, contact details, vehicle registration, flight information, and payment details." },
    ...
    },
    {
      ...
      questions: [
        ...
        { q: "How can I contact you?", a: "Phone: 01202 798710 (24/7 for emergencies on day of travel), Email: info@tagparking.co.uk, Website: www.tagparking.co.uk. Office hours: Monday-Friday, 9:00 AM - 5:00 PM." }
      ]
    }
  ]
    ...
    <div className="legal-page">
      ...
      <div className="legal-container faq-container">
        ...
        <div className="legal-content faq-content">
          ...
          <p className="faq-contact"><strong>Quick Contact:</strong> Phone: 01202 798710 | Email: info@tagparking.co.uk</p>
          ...
          <div className="faq-still-questions">
            ...
            <div className="faq-contact-details">
              <p><strong>Phone:</strong> 01202 798710 (Available 24/7 for emergencies on day of travel)</p>
